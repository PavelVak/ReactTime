...
class Clock extends Component {
    constructor(props) {
        ...
        let offset = this.props.date._offset * 60 * 1000 + currentOffset;
        let time = new Date(+new Date(this.props.date) + offset);
    ...
    tick() {
        this.setState({ time: new Date(+this.state.time + 1000) });
